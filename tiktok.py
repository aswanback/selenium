...
def tik_tok_farmer(folder, number):
    ...
    try:
        ...
        get.by_xpath("/html/body/div/div[2]/div[1]/form/div/div[1]/div/input").send_keys("nrubenstein0405@gmail.com") # username
        get.by_xpath("/html/body/div/div[2]/div[1]/form/div/div[2]/div/input").send_keys("nacny123") # password
